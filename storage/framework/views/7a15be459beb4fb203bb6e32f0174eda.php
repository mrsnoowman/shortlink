    ...
    <div class="page">
                ...
                <div>
                    ...
                    <div class="hero-meta">
                        <div class="hero-meta-item">
                            <span>Editorial</span>
                            <span>Disusun oleh tim AE News · <?php echo e(date('d M Y')); ?></span>
                        </div>
                        <div class="hero-meta-item">
                            <span>Topik</span>
        ...
        <main class="main">
            ...
            <article class="news-card">
                ...
                <div class="news-content">
                    ...
                    <div class="news-meta">
                        <span class="news-date">📅 <?php echo e(date('d M Y')); ?></span>
            ...
            <article class="news-card">
                ...
                <div class="news-content">
                    ...
                    <div class="news-meta">
                        <span class="news-date">📅 <?php echo e(date('d M Y', strtotime('-1 day'))); ?></span>
            ...
            <article class="news-card">
                ...
                <div class="news-content">
                    ...
                    <div class="news-meta">
                        <span class="news-date">📅 <?php echo e(date('d M Y', strtotime('-2 days'))); ?></span>
            ...
            <article class="news-card">
                ...
                <div class="news-content">
                    ...
                    <div class="news-meta">
                        <span class="news-date">📅 <?php echo e(date('d M Y', strtotime('-3 days'))); ?></span>
            ...
            <article class="news-card">
                ...
                <div class="news-content">
                    ...
                    <div class="news-meta">
                        <span class="news-date">📅 <?php echo e(date('d M Y', strtotime('-4 days'))); ?></span>
                        ...
                        <article class="news-card">
                            ...
                            <div class="news-content">
                                ...
                                <div class="news-meta">
                                    <span class="news-date">📅 <?php echo e(date('d M Y', strtotime('-5 days'))); ?></span>
        ...
        <footer class="footer">
            <div class="footer-inner">
                <div>© <?php echo e(date('Y')); ?> AE News · aelink.click · All rights reserved.</div>
...
<?php /**PATH C:\MrSnowman\APLICATION\Old PC\shortlink\resources\views/welcome.blade.php ENDPATH**/ ?>